    ...
    <>
        <div key={Finalproduct.id} className="group relative" onClick={() => setOpen(true)}>
            ...
            <div>
                ...
                {/* <a href={Finalproduct.href}> */}
                    <span aria-hidden="true" className="absolute inset-0" />
                    {Finalproduct.name}
                {/* </a> */}
                </h3>
                <p className="mt-1 text-sm text-gray-500">{Finalproduct.color}</p>
            </div>
            <p className="text-sm font-medium text-gray-900">{Finalproduct.price}</p>
            </div>
        </div>
